...
public class MathVisualElement extends JPanel implements MultiViewElement {
  ...
  public void componentOpened() {
    ...
    styleSheet.addRule("UL {color:red; font-size:16; font-style:normal; }");
    styleSheet.addRule("OL {color:black; font-size:18; font-style:normal; }");
    try {
      display();
    } catch (Exception ex) {
      Exceptions.printStackTrace(ex);
  ...
  private void display() throws Exception {
    ...
    Generator gen = mtc.getGenerator();
    output.append("<H1>").append(gen.getName()).append("</H1>");
